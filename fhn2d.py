...
def fhn2d(N, T, t0, a, b, c, I0, s, D, dt, stim, blocks):
    c1 = 1/c
...
def main():
    ...
    D = 1.0
    dt = 0.1
    print("[+] FitzHugh-Nagumo 2D lattice:")
    ...
    # run simulation
    data = fhn2d(N, T, t0, a, b, c, I, s, D, dt, stim, blocks)
    ...
    # save data
    data_filename = f"fhn2d_I_{I:.4f}_s_{s:.4f}_D_{D:.4f}.npy"
    #np.save(data_filename, data)
    #println("[+] Data saved as: ", data_filename)
    mov_filename = f"fhn2d_I_{I:.4f}_s_{s:.4f}_D_{D:.4f}.mp4"
    array_to_mp4(mov_filename, data)
    print("[+] Data saved as: ", mov_filename)
