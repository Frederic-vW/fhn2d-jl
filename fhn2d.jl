...
function fhn2d(N, T, t0, a, b, c, I0, s, D, dt, stim, blocks)
    c1 = 1/c
...
function main()
    ...
    data_filename = string("fhn2d_I_", I_str, "_s_", s_str, "_D_", D_str, ".npy")
    #npzwrite(data_filename, data)
    #println("[+] Data saved as: ", data_filename)
    mov_filename = string("fhn2d_I_", I_str, "_s_", s_str, "_D_", D_str, ".mp4")
